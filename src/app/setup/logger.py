...
def load_logger() -> None:
    ...
    level = __get_assert_level( level = log_cfg.__level )
    output_dir = __create_output_dir( output_dir = log_cfg.__out_dir )
    filename = get_timestamp_filename( filename = log_cfg.__filename )
