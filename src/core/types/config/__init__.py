...
from core.types.config.config_quote_type import ConfigQuoteType, ConfigQuoteCanvasType, ConfigQuoteImgsType
from core.types.config.config_type import ConfigType
